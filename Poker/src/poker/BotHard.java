...
public class BotHard extends Hand {
	...
	public BotHard(int colour2[], int number2[])
	{
	...
	void Swap()	
	{
		...
		for(int p=0;p<(2*2*2*2*2);p++)
		{
			...
			posi=0;
			total=0;
			for(int i=0;i<(52*52*52*52*52);i++)
			{
				help1=i;
				for(int k=0;k<5;k++)
				{
					hcard[k]=help1%52;
					help1=(help1-hcard[k])/52;	
					hcolour[k]=hcard[k]%4;
					hnumber[k]=((hcard[k]-(hcolour[k]))/4)+2;
				}
