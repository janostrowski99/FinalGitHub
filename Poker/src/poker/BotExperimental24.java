...
public class BotExperimental24 extends Hand {
	...
	public BotExperimental24(int colour2[], int number2[])
	{
	...
	public BotExperimental24(Hand hand, int[] memory)
	{
		...
		for(int i=1;i<10;i++)
		{
			multi[i]=(memory[i]/b)+a+r.nextInt(2)-1;
			a=a+multi[i];
